...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--directory', type=str, required=True, default=None, help='folder to save synthesized audio')
    ...
    with torch.no_grad():
        for i, text in enumerate(texts):
            ...
            x = torch.IntTensor(text).cuda()[None]
            ...
            write(f'{args.directory}/{file_name}', 22050, audio)
